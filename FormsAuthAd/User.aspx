<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="Compendiums.User" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <div class="container containertop">
            ...
            <asp:Button ID="btnShow" runat="server" Text="Add User" class="adduser" /></td>
                    <td align="right"><asp:DropDownList ID="dddlDC" class="ddl" runat="server" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="IndexChanged"></asp:DropDownList><asp:Label ID="EditIndex" runat="server" Text="" Visible="false"></asp:Label></td>
                </tr></table>
                    </td>
                </tr>
                <tr>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Permission" SortExpression="Permission">
                        <EditItemTemplate>
                            <asp:DropDownList ID="ddleditPermission" runat="server" Text='<%# Bind("Permission") %>' ><asp:ListItem>Admin</asp:ListItem><asp:ListItem>Kitchen</asp:ListItem><asp:ListItem>Basic</asp:ListItem></asp:DropDownList>
            ...
            <div align="center"><br />
                ...
                <table>
                    ...
                    <tr height="50px">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlPermission" Width="200px" runat="server"><asp:ListItem>Admin</asp:ListItem><asp:ListItem>Kitchen</asp:ListItem><asp:ListItem>Basic</asp:ListItem></asp:DropDownList>
